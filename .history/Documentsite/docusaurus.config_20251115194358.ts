...
const config: Config = {
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      // 共有時の絶対URLも独自ドメインにそろえる（任意だが推奨）
      {name: 'twitter:image', content: 'https://docs.ozeu.net/img/ozeu-social-card.png'},
      {property: 'og:type', content: 'website'},
      {property: 'og:title', content: 'OZEU  - Discord荒らし'},
      {property: 'og:description', content: 'おぜうの集い荒兵器公式Document！'},
      {property: 'og:image', content: 'https://docs.ozeu.net/img/ozeu-social-card.png'},
      {property: 'og:image:width', content: '1200'},
      {property: 'og:image:height', content: '630'},
      {property: 'og:url', content: 'https://docs.ozeu.net/'},
